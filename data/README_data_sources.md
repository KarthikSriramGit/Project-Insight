...
This document outlines sources and procedures for obtaining real robotics and autonomous vehicle telemetry to use with Project Insight. The pipeline supports Parquet and CSV formats matching the telemetry schema (IMU, LiDAR, CAN, GPS, camera).

## Open Datasets

### nuScenes
CAN bus, LiDAR, camera, IMU from real autonomous vehicles. Requires conversion to the Project Insight schema (timestamp_ns, vehicle_id, sensor_type, and sensor-specific columns). Download from https://www.nuscenes.org/
